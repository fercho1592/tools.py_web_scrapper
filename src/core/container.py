"""Container implementation (migrated from `feature.container`).

This file provides the canonical `Container` class under
`core.container` so callers can import from `core.container` after
