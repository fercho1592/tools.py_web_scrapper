...
from core.services.user_feedback_handler import ProgressBar
...
class MangaScraper:
    ...
    def set_starting_page(self, page_number: int = 0) -> None:
        try:
            ...
            (_, lastNumber) = first_page.get_image_number()
            ...
            raise RuntimeError("Error getting manga data") from ex
    ...
    def download_current_page(self, folderPath: FolderPath) -> None:
        ...
        try:
            ...
            raise RuntimeError("Error downloading image") from ex
    ...
    def set_next_page(self) -> bool:
        try:
            ...
            raise RuntimeError("Error getting next page") from ex
